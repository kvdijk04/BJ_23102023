...
namespace BJ.Persistence.Migrations
{
    ...
    [Migration("20231122014136_AddDayMonthYearNumberOfVisitorCounter")]
    partial class AddDayMonthYearNumberOfVisitorCounter
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BJ.Domain.Entities.VisitorCounter", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6a049d01-7f3b-4523-82c6-a89cb58285d6"),
                            Day = 22,
                            DayCount = 0L,
                            Month = 11,
                            MonthCount = 0L,
